    ...
    async function rellenarYardageBook(datos) {
        ...
        Object.keys(orderedClubs).forEach(async (clubName) => {
            ...
            if (datos[clubCode]) {
                ...
                const imageUrl = 'https://raw.githubusercontent.com/FrancoPanfilo/FrancoPanfilo.github.io/main/AzaleaGolf/Simulador/flecha-doble.png';
        ...
        firstPage.drawText(`${fechaFormateada}`, { x: 10, y: 360, size: 11, font: fontRegular });
